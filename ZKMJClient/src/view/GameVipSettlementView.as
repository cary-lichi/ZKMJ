package view 
{
	 ...
	 * @author ...
	 */
	public class GameVipSettlementView extends GameSettlementView 
	{
		
		public function GameVipSettlementView() 
		{
			super();
		...
		public override function SetGamerBottomInfo(gamerInfo:*,gamer:*,message:*):void 
		{
			...
			if (gamerInfo.nGameCoin > 0) {
				m_score0.text = "+" + gamerInfo.nGameCoin.toString()+"分";
				m_score0.color = "#f7f200";
			}
			else if (gamerInfo.nGameCoin < 0)
			{
				m_score0.text = gamerInfo.nGameCoin.toString()+"分";
		...
		public override function SetGamerLeftInfo(gamerInfo:*,gamer:*):void 
		{
			...
			if (gamerInfo.nGameCoin > 0) {
				m_score1.text = "+" + gamerInfo.nGameCoin.toString()+"分";
		...
		public override function SetGamerTopInfo(gamerInfo:*,gamer:*):void 
		{
			...
			if (gamerInfo.nGameCoin > 0) {
				m_score2.text = "+" + gamerInfo.nGameCoin.toString()+"分";
		...
		public override function SetGamerRightInfo(gamerInfo:*,gamer:*):void 
		{
			...
			if (gamerInfo.nGameCoin > 0) {
				m_score3.text = "+" + gamerInfo.nGameCoin.toString()+"分";
